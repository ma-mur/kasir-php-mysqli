...
<div class="wrapper d-flex">
    <div class="sideMenu">
    	<div class="sidebar">
        	<ul class="navbar-nav">
				<li class="nav-item">
					<a href="kasir/dashboard.php" class="nav-link px-2 <?php echo $uri[3] == 'dashboard.php' ? 'active' : '' ?>">
						<span class="text"> Dashboard</span>
					</a>
				</li>
				<li class="nav-item">
					<a href="kasir/penjualan.php" class="nav-link px-2  <?php echo $uri[3] == 'penjualan.php' ? 'active' : '' ?>">
						<span class="text"> Transaksi Penjualan</span>
					</a>
				</li>	
				<li class="nav-item ">
					<a href="kasir/data_produk.php" class="nav-link px-2  <?php echo $uri[3] == 'data_produk.php' ? 'active' : '' ?>">
						<span class="text"> Data Produk</span>
					</a>
				</li>
				
				<li class="nav-item">
					<a href="kasir/laporan.php" class="nav-link px-2  <?php echo $uri[3] == 'laporan.php' ? 'active' : '' ?>">
